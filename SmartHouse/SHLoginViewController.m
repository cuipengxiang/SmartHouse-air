...
- (void)viewDidLoad
{
    ...
    self.imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0.0, 0.0, 768, 1024)];
    ...
    if (UIInterfaceOrientationIsLandscape(self.interfaceOrientation)) {
        [self.imageView setFrame:CGRectMake(0.0, 0.0, 1024, 768)];
        [self.imageView setImage:[UIImage imageNamed:@"login_bg"]];
        ...
        [self.imageView setFrame:CGRectMake(0.0, 0.0, 768, 1024)];
